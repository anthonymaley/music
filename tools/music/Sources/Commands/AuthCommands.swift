...
struct AuthSetup: ParsableCommand {
    ...
    func run() throws {
        ...
        print("============================")
        print("")
        print("This requires an Apple Developer account ($99/year).")
        print("You need a MusicKit key from https://developer.apple.com")
        print("")
        print("To create one:")
        print("  1. Go to developer.apple.com → Account → Keys")
        print("  2. Click + to create a new key")
        print("  3. Name it anything, enable 'Media Services (MusicKit)'")
        print("  4. Download the .p8 file")
        print("  5. Note the Key ID (shown on the key details page)")
        print("  6. Note your Team ID (Account → Membership)")
        print("")
